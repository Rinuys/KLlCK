    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="class-evaluate.html">강의평</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="reports.html">족보 / 레포트</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownBlog">
              <a class="dropdown-item" href="my-status.html">내 정보</a>
              <a class="dropdown-item" href="status-modify.html">내 정보 변경</a>
              <a class="dropdown-item" href="subscribe.html">구독 내역</a>
            </div>
          </li>
        </ul>
      </div>
      ...
      <div class="col-lg-4 mb-4">
        <div class="card h-100">
          ...
          <div class="card-footer">
            <a href="reports.html" class="btn btn-primary">다른 강의평 보기</a>
          </div>
        </div>
      </div>
      <div class="col-lg-4 mb-4">
