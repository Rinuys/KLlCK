		...
		<div class="row">
			<div class="col-lg-4 mb-4">
				<div class="card h-100">
					...
					<div class="card-body">
						<p class="card-text">교수님은 친절하시고 좋으신데 중간고사 없는 대신 퀴즈 몇번 보고 에세이
							작성하는 과제는 자주 있습니다.</p>
					</div>
			...
			<div class="col-lg-4 mb-4">
				<div class="card h-100">
					...
					<div class="card-body">
						<p class="card-text">엄청 열정적이신 교수님. 약간 고등학교식 수업? 직접 말하고 적으라는 거
							적고 참여 안할 수 없는 수업이다.</p>
					</div>
					<div class="card-footer">
						<a href="reports.jsp" class="btn btn-primary">다른 강의평 보기</a>
					</div>
			...
			<div class="col-lg-4 col-sm-6 portfolio-item">
				<div class="card h-100">
					<div class="card-header">
						<a href="#"><img class="board-profile"
							src="http://www.localsegye.co.kr/news/data/20181016/p1065594974453059_805_thum.jpg"
							alt=""><span>닉네임</span></a>
					</div>
					<div class="card-body">
						<h4 class="card-title">
