...
<body>
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="index.jsp">공지사항</a></li>
		</ol>
		...
		<!-- Team Members -->
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="index.jsp">자유게시판</a></li>
		</ol>
		...
		<!-- 자유게시판 글쓰기 모달 -->
		<a class="btn btn-primary mx-1 ml-1 mb-2 mt-2" data-toggle="modal"
			href="#freeRegisterModal">등록하기</a> <br>




		<div class="modal fade" id="freeRegisterModal" tabindex="-1"
			role="dialog" area-labelledby="modal" aria-hidden="true">
						...
						<form action"./freeBoardRegisterAction.jsp" method="post">
							<div class="form-row">
								<div class="form-group col-sm-10 ml-3">
									<label>제목</label> <input type="text" name="freeBoardTitle"
										class="form-control" maxlength="20" placeholder="글제목">
								</div>
								<div class="form-group col-sm-10 ml-3">
									<label>글내용</label>
									<textarea name="freeBoardTitle" class="form-control"
										style="height: 300px" maxlength="2048" placeholder="글내용"></textarea>
								</div>
					...
					<div class="card-body">
						<div class="card-body-top">
							<img class="card-profile"
								src="http://artzone.indiecolaj.com/images/24/dp.jpg" alt="">
